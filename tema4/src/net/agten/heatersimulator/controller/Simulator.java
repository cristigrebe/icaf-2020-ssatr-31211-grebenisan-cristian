...
public class Simulator {
	...
	public XYDataset runSimulation(SimulationParameters params, FuzzyParameters fuzzyParameters) {
		ControllerAlgorithm fuzzy = new FuzzyController(
				fuzzyParameters.getpGain(),
				fuzzyParameters.getiGain(),
				fuzzyParameters.getdGain(),
				fuzzyParameters.getOutputDivisor());
		return runSimulation(params, fuzzy);
	}
